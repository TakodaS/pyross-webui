...
class miniPieChart {
	...
	private _pieChart: am4charts.PieChart | undefined = undefined
	private series: am4charts.PieSeries | undefined = undefined
	...
	private initPieChart(): void {
		...
		this._pieChart.scale = 1
		this._pieChart.radius = am4core.percent(55)
		this._pieChart.innerRadius = am4core.percent(0)
		this._pieChart.x = am4core.percent(-20)
		this._pieChart.y = am4core.percent(-15)
		//this._pieChart.zIndex = 100;

		//console.log( "this BIG piechart is", this, "\nbigPieChart is", this.bigPieChartWidget)
	...
	private setEvents(): void {
		...
		holdClassThisContext.series.slices.template.events.on("hit", function (
			ev: any
		) {
		...
		holdClassThisContext.series.slices.template.events.on("over", function (
			ev: any
		) {
			let slice = ev.target
		...
		holdClassThisContext.series.slices.template.events.on("out", function (
			event: any
		) {
			let smcolor = holdClassThisContext.getSmallPieColor()
