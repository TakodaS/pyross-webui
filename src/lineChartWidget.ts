...
class lineChartWidget {
  ...
  constructor(
    name: string,
    mchart: mapOfUKWidget,
    pchart: pieChartWidget,
    dclass: DataClass
  ) {
    this._name = name
    this.mchart = mchart
  ...
  initLineChart(): void {
    ...
    //Annotatios and Enable export
    this._lineChart.exporting.menu = new am4core.ExportMenu()
    let annotation = this._lineChart.plugins.push(
