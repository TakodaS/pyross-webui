...
exports.pieChart = exports.UKmap = void 0;
const am4core = __importStar(require("@amcharts/amcharts4/core"));
const am4maps = __importStar(require("@amcharts/amcharts4/maps"));
const am4charts = __importStar(require("@amcharts/amcharts4/charts"));
const ukCountiesHigh_1 = __importDefault(require("@amcharts/amcharts4-geodata/ukCountiesHigh"));
function UKmap(label, selectedCounties) {
    ...
    // Set map definition
    mapChart.geodata = ukCountiesHigh_1.default;
    // Set projection
    ...
    function setSmallMapColor(smcolor) {
        if ((smcolor == inactiveColor)) {
    ...
    function checkIfAllCountiesAreSame() {
        let allActive = true;
...
exports.UKmap = UKmap;
////////////////////////////////////////////////////////////////////////////////////////
function pieChart(label, selectedAges) {
...
//# sourceMappingURL=UIwidgets.js.map